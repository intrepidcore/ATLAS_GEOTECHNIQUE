-- Correction de la fonction auto_accept_high_score_suggestions pour éviter l'ambiguïté

BEGIN;

-- Recréer la fonction avec les alias corrects
...
BEGIN
    ...
    FOR suggestion_rec IN
        ...
        INNER JOIN public.sondages s ON s.id = gs.entity_id
    ...
    LOOP
        BEGIN
            ...
            -- Géocoder le sondage avec alias explicites
