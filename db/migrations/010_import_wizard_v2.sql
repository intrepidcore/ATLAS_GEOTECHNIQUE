-- Migration 010: Import Wizard v2.3.0
-- Tables pour le système d'import avec batch tracking, undo, et audit trail
...
CREATE TABLE IF NOT EXISTS imports (
  ...
  user_id TEXT,
  status TEXT NOT NULL DEFAULT 'pending', -- pending|running|completed|failed|undone
...
-- Ajouter colonnes batch tracking aux tables existantes
