-- Recréer mv_mailles_geotech puis mailles_geotechnique_stats_wgs84

-- D'abord mv_mailles_geotech
CREATE OR REPLACE VIEW atlas.mv_mailles_geotech AS
SELECT * FROM atlas.v_mailles_with_location_counts;

-- Puis mailles_geotechnique_stats_wgs84
...
SELECT 
    ...
    m.eg_rk_h2,
    m.eg_rk_h3
FROM atlas.v_mailles_with_location_counts mv
