...
export const Input: React.FC<{
  ...
  <input
    ...
    onChange={onChange}
    disabled={disabled}
    className={`block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 ${disabled ? 'opacity-50 cursor-not-allowed bg-gray-50' : ''} ${className}`}
  />
);
