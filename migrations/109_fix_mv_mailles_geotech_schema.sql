-- ============================================================================
-- MIGRATION 109 : FIX MV_MAILLES_GEOTECH (schema source)
-- Objectif : la MV doit être basée sur atlas.mailles (grille V2) et non public.mailles (legacy)
-- ============================================================================
...
maille_echantillons AS (
    ...
    LEFT JOIN atlas.echantillons e ON e.sondage_id = ms.sondage_id
),
...
agg_atterberg AS (
    ...
    LEFT JOIN atlas.essais_atterberg ea ON ea.echantillon_id = me.echantillon_id
...
agg_vbs AS (
    ...
    FROM maille_echantillons me
    LEFT JOIN atlas.essais_vbs ev ON ev.echantillon_id = me.echantillon_id
...
agg_proctor AS (
    ...
    FROM maille_echantillons me
    LEFT JOIN atlas.essais_proctor ep ON ep.echantillon_id = me.echantillon_id
...
agg_gonflement AS (
    ...
    FROM maille_echantillons me
    LEFT JOIN atlas.essais_potentiel_gonflement eg ON eg.echantillon_id = me.echantillon_id
...
agg_granulo AS (
    ...
    FROM maille_echantillons me
    LEFT JOIN atlas.granulo_points gp ON gp.echantillon_id = me.echantillon_id
...
agg_classif AS (
    ...
    FROM maille_echantillons me
    LEFT JOIN atlas.essais_classif ec ON ec.echantillon_id = me.echantillon_id
